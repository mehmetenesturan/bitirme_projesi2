...
namespace proje.MvcWebUI.Entity
{
    public class DataInitializer: DropCreateDatabaseIfModelChanges<DataContext>
    {
        protected override void Seed(DataContext context)
        {
            ...
            {
                new Product(){Name="13 inç Macbook Air",Description="M1 çip, 8 çekirdek, 256gb",Price=20999, Stock=100, IsApproved=true, CategoryId=1, Image="1.jpg"},
                new Product(){Name="13 inç Macbook Air ",Description="M2 çip, 8 çekirdek, 256gb",Price=25999, Stock=100, IsApproved=true, CategoryId=1, IsHome=true, Image="2.jpg"},
                ...
                new Product(){Name="14 inç Macbook Pro",Description="M2 çip, 10 çekirdek, 512 gb",Price=41999, Stock=100, IsApproved=true, CategoryId=1, IsHome=true, Image="4.jpg"},
                ...
                new Product(){Name="Apple Watch Series 3",Description="45 mm veya 41 mm",Price=4199, Stock=100, IsApproved=true, CategoryId=2, Image="1.jpg"},
                new Product(){Name="Apple Watch SE ",Description="44 mm veya 40 mm",Price=5849, Stock=100, IsApproved=true, CategoryId=2, Image="2.jpg"},
                new Product(){Name="Apple Watch Series 7",Description="42 mm veya 38 mm",Price=8399, Stock=100, IsApproved=true, CategoryId=2, IsHome=true, Image="3.jpg"},

                new Product(){Name="iPad mini",Description="8.3 inç",Price=11199, Stock=100, IsApproved=true, CategoryId=3, Image="1.jpg"},
                ...
                new Product(){Name="iPhone 12",Description="6.1 inç veya 5.4 inç",Price=18999, Stock=100, IsApproved=true, CategoryId=4,},
